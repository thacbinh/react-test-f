...
interface IProps {
    ...
    setOpenUpdateBook: (p: boolean) => void
    bookUpdate: IBookTable | null
    setBookUpdate: (p: IBookTable | null) => void
    refreshTable: () => void
}
...
const UpdateBook = (props: IProps) => {
    const { openUpdateBook, setOpenUpdateBook, bookUpdate, setBookUpdate, refreshTable } = props;
